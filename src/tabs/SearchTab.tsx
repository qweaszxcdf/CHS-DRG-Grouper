...
const SearchResultRow = memo(function SearchResultRow({ item, isCopied, onCopy }: { item: CodeSearchItem; isCopied: boolean; onCopy: (code: string) => void }) {
  return (
...
export default function SearchTab({ searchSource, version, codeIndexRevision = 0 }: { searchSource: string; version: string; codeIndexRevision?: number }) {
